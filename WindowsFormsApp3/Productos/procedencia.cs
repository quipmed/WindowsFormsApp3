...
{
    public partial class procedencia : Form
    {
        ...
        public procedencia()
        {
            ...
            dataGridView1.Columns[1].Name = "Procedencia";
        ...
        private void btAgregar_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Captura una procedencia porfavor", "Falta agregar procedencia", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
            else
            {
        ...
        {
            //SQL STATEMENT
            string sql = "UPDATE tbProcedencia SET nombreProcedencia='" + puesto + "' WHERE idProcedencia=" + id + "";
        ...
        private void procedencia_Load(object sender, EventArgs e)
        {
            btEditar.Visible = false;
            retrieve();
        }
        ...
        {
            //SQL STMT
            const string sql = "INSERT INTO tbProcedencia(nombreProcedencia) VALUES(@nombre)";
            cmd = new MySqlCommand(sql, con);
        ...
        private void retrieve()
        {
            ...
            //SQL STATEMENT
            String sql = "SELECT * FROM tbProcedencia ";
            cmd = new MySqlCommand(sql, con);
            try
            {
                con.Open();
        ...
        private void procedencia_FormClosing(object sender, FormClosingEventArgs e)
        {
